...
class AzureTextTranslationTool(BaseTool):
    ...
    name: str = "azure_translation tool"
    description: str = (
        "A wrapper around Azure Text Translation API. "
        "Useful for when you need to convert text to a given language."
    )
    return_direct: bool = True

    azure_translation_services_key: str = ""  #: :meta private:
    azure_translation_services_region: str = ""  #: :meta private:
    output_language: str = "en-US"  #: :meta private:
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError(
                "azure.core.credentials is not installed. "
                "Run `pip install azure.core.credentials` to install."
            )
